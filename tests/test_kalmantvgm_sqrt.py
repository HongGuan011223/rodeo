...
import src.rodeo.kalmantv_sqrt as sqrt_ktv
import tests.utils as utils
from src.rodeo.utils import mvncond
...
class TestKalmanTVGM(unittest.TestCase):
    ...
    def test_predict(self):
        ...
        #f_state_pred1 = jnp.linalg.cholesky(var_state_pred1) # sqrtm to Gaussian Markov matrix
        ...
        #print(var_state_pred1)
        #print(jnp.dot(var_state_pred1,var_state_pred1.T))
        
        self.assertAlmostEqual(utils.rel_err(mean_state_pred1, mean_state_pred2),0.0) # mean keep same as kalman algorithm
        self.assertAlmostEqual(utils.rel_err(var_state_pred1, jnp.dot(var_state_pred2,var_state_pred2.T)), 0.0) # Decimal places to 2
    ...
    def test_update(self):
        ...
        # print(var_state_filt2)
        
       # print(utils.rel_err(mean_state_filt1, mean_state_filt2))      - 1.0925978e-06
       # print(mean_state_filt1)
       # print(mean_state_filt2)

        self.assertAlmostEqual(utils.rel_err(mean_state_filt1, mean_state_filt2), 0.0)
        self.assertAlmostEqual(utils.rel_err(var_state_filt1, jnp.dot(var_state_filt2,var_state_filt2.T)), 0.0)
    ...
    def test_filter(self):
        ...
        self.assertAlmostEqual(utils.rel_err(var_state_pred1, jnp.dot(var_state_pred2,var_state_pred2.T)), 0.0)
        self.assertAlmostEqual(utils.rel_err(mean_state_filt1, mean_state_filt2), 0.0)
        self.assertAlmostEqual(utils.rel_err(var_state_filt1, jnp.dot(var_state_filt2,var_state_filt2.T)), 0.0)
    ...
    def test_smooth_mv(self):
        ...
        self.assertAlmostEqual(utils.rel_err(var_state_smooth1, jnp.dot(var_state_smooth2,var_state_smooth2.T)), 0.0)
    ...
    def test_smooth_sim(self):
        ...
        self.assertAlmostEqual(utils.rel_err(V, jnp.dot(var_state_sim2,var_state_sim2.T)), 0.0, places=2)
    ...
    def test_smooth(self):
        ...
        self.assertAlmostEqual(utils.rel_err(var_state_smooth1[0, :, 0, :].squeeze(),
                                             jnp.dot(var_state_smooth2,var_state_smooth2.T)), 0.0)
